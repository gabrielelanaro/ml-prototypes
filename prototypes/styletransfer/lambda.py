...
available_instances = ["g2.2xlarge", "g2.8xlarge", "g3.16xlarge", "g3.4xlarge", "g3.8xlarge",
                       "g3s.xlarge", "p2.8xlarge", "p2.xlarge", "p3.2xlarge", "p3.8xlarge"]
...
def lambda_handler(event, context):
    ...
    if not instance: 
        return format_response(f"id: 'limit exceeded', type: 'limit exceeded', dns: 'limit exceeded'", 200) 
    ...
    return format_response(f"id: {instance_id}, type: {INSTANCE_TYPE}, dns: {public_dns}", 200)